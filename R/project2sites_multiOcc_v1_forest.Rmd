---
title: "Project forest model to sites"
author: "Liz Law"
date: "2022-10-17"
...
# define the (max) number of samples we want to draw
nsamples <- 1000
...
set.seed <- 123
mydraw <- sample(1:nrow(posterior_matrix), size=min(nsamples, nrow(posterior_matrix)), replace = FALSE)
posterior_matrix <- posterior_matrix[mydraw,]  
...
out_betalp4[] <- rep(posterior_matrix[, "betalp[4]"], each = (nrow(values_to_predict)*M))
