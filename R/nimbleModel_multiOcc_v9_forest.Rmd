...
```{r save results}
saveRDS(samples, paste0(results_folder, version_folder, "BirdOccMod_dOcc_samples_forest_",format(Sys.time(), "%Y%m%d"), ".RDS"))
...
# caterpillar plots
MCMCplot(samples, 
         params = pg1, # params = 'betalpsi\\[\\d{1,3}[,][ ][1]\\]', ISB = FALSE, exact = FALSE, 
         ci = c(50, 90), 
