#  "bayesBirdModel_multiSPecies_v6 - forestData"
#  author: "Liz Law"
#  date: "22 Mar 2022
...
saveRDS(list(version="Forest_v6", 
             y=y,
             OccVarsFrst=OccVarsFrst,
             ObsVarsFrst=ObsVarsFrst,
             Nadd=26),
        "/Users/elaw/Desktop/LeuphanaProject/BirdModelling/Leuphana_Bird_Modelling/nimbleMultiOcc/nimbleModel_multiOcc_v6_forestData.RDS"
        )
