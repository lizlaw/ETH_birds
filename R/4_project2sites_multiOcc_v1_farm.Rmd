---
title: "Site-based model assessment - farm"
author: "Liz Law"
date:  "`r Sys.Date()`"
output: html_document
---
# project the FARM model across the sampled sites
...
for (k in 1:dim(array_NA)[2]) {
          ...
          out_betalpsi4[, k, ] <- posterior_matrix[, colnames(posterior_matrix) %in% 
                                                     paste0("betalpsi", "[", k, 
                                                            ", 4]")]
          out_betalpsi5[, k, ] <- posterior_matrix[, colnames(posterior_matrix) %in% 
                                                     paste0("betalpsi", "[", k, 
                                                            ", 5]")]
}
...
out_logitpsi <- out_lpsi  +
  ...
  out_betalpsi5 * values_to_predict[,5] 
