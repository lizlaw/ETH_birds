...
MCMCtrace(samples, 
          ...
          filename = paste0(results_folder, version_folder, "plots_traceDensity_pg1_farm_", format(Sys.time(), "%Y%m%d"), ".pdf"))
MCMCtrace(samples, 
          params = pg2,
          ind = TRUE, 
          Rhat = TRUE, n.eff = TRUE,
          filename = paste0(results_folder, version_folder, "plots_traceDensity_pg2_farm_", format(Sys.time(), "%Y%m%d"), ".pdf"))
